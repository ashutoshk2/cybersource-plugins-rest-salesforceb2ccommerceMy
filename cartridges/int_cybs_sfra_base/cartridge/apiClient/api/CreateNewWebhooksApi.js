...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('../model/CreateWebhook'), require('../model/InlineResponse2006'), require('../model/InlineResponse2015'), require('../model/InlineResponse2016'), require('../model/SaveSymEgressKey'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.CreateNewWebhooksApi = factory(root.CyberSource.ApiClient, root.CyberSource.CreateWebhook, root.CyberSource.InlineResponse2006, root.CyberSource.InlineResponse2015, root.CyberSource.InlineResponse2016, root.CyberSource.SaveSymEgressKey);
  }
}(this, function(ApiClient, CreateWebhook, InlineResponse2006, InlineResponse2015, InlineResponse2016, SaveSymEgressKey) {
  'use strict';
 ...
 this.apiClient.setConfiguration(configObject);
    ...
    this.findProductsToSubscribe = function(organizationId, callback) {
      ...
      // This gateway has no application/hal+json representation for /products (it 406s); it serves
      // application/json like the sibling /webhooks endpoint. Accept json to avoid the 406.
